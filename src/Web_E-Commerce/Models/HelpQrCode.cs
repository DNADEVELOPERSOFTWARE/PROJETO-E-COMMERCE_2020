...
namespace Web_E_Commerce.Models
{
    public class HelpQrCode : Controller
    {
        ...
        //        #region Numerações das páginas
        //        int qtdPaginas = doc.PageCount;

        //        var marcacaoPaginas = new PdfSharpCore.Drawing.Layout.XTextFormatter(graphics);

        //        marcacaoPaginas.DrawString(Convert.ToString(qtdPaginas), new PdfSharpCore.Drawing.XFont("Arial", 10), corFonte, new PdfSharpCore.Drawing.XRect(
        //                                    575, 825, page.Width, page.Height));
        //        #endregion

        //        #region Logo
        //        var webRoot = _environment.WebRootPath;

        //        var logoFatura = string.Concat(webRoot, "/img/", "lojaVirutal-1.png");
        ...
        //        detalhes.DrawString("Banco Itau ag 004", tituloInfo_1, corFonte, new XRect(150, alturaTitulodetalhesY, page.Width, page.Height));
        ...
        //        detalhes.DrawString("000000-000000-123123-654456", tituloInfo_1, corFonte, new XRect(150, alturaTitulodetalhesY, page.Width, page.Height));
        ...
        //        detalhes.DrawString("Canhoto para pagamento online", tituloInfo_1, corFonte, new XRect(150, alturaTitulodetalhesY, page.Width, page.Height));

        //        #endregion

        //        using(MemoryStream stream = new MemoryStream())
        //        {
        //            var contetType = "application/pdf";

        //            doc.Save(stream,false);
        //            return File(stream.ToArray(), contetType, "BoletoLojaVirtualOnline.pdf");
        //        }   
        //    }
        //}
        public async Task<IActionResult> Download(CompraUsuario compraUsuario, IWebHostEnvironment _environment)
        {
            ...
            using (var doc = new PdfSharpCore.Pdf.PdfDocument())
            {
                ...
                try
                {
                    var img = await GeraQrCode("" +
                        "Dados Usuario:" +
                        "Nome: Jose Paulo - " +
                        "Endereço: Rua dos tolos 171" +
                        "Banco Povão - agencia 171 " +
                        "pagavél ara qualquer otario que quiser pagar");
